...
namespace TrackingVoucher_v02.Controllers
{
    ...
    public class VouchersController : ControllerBase
    {
        ...
        [HttpGet("claimed-vouchers/use/{id}")]
        public ActionResult<ClaimedVoucher> ClaimedVoucherUseOneTime(int id)
        {
            bool success = _claimedSer.DecreaseAvailableByOne(id);
            if (success)
            {
                return Ok("Decrease Successful!");
            }
            return Problem("Decrease Failed!");
        }
